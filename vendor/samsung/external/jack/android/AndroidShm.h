...
#define MAX_SHARED_MEMORY_COUNT 257
        private:
			...
			void setCallingPid(int index);
			inline bool isRemoveShmAllowed(const int index);
        ...
        private:
			...
			int mCallingPids[MAX_SHARED_MEMORY_COUNT];
			...
			int mSemaphorePids[MAX_SEMAPHORE_MEMORY_COUNT];
    };
};
