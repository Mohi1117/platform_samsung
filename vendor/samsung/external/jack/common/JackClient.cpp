...
int JackClient::JackNullProcessCallback(jack_nframes_t nframes, void *arg){
	jack_log("JackClient::JackNullProcessCallback");
	return 1; // to end this callback
}

void JackClient::Cleanup()
{
	jack_log("JackClient::Cleanup");
	fProcess = JackNullProcessCallback;
	fGraphOrder = NULL;
	fXrun = NULL;
	fShutdown = NULL;
	fInfoShutdown = NULL;
