...
ifeq (,$(findstring mt,$(TARGET_BOARD_PLATFORM)))
#include $(CLEAR_VARS)
#LOCAL_MODULE := libdevkm_dmverity
#LOCAL_MODULE_TAGS := optional
#LOCAL_PREBUILT_LIBS := libdevkm_dmverity.a
...
ifeq ($(PRODUCT_TRUSTZONE_TYPE), $(filter eos2 exynos3xxx exynos4xxx exynos5xxx exynos7xxx exynos8xxx msm8952 msm8937 msm8953 msm8916 msm8974 msm8994 msm8996 msm8998 msm89xx msm8x26 QC8064 QC8084,$(PRODUCT_TRUSTZONE_TYPE)))
...
ifeq ($(TARGET_SOC),MT6757)
LOCAL_SRC_FILES := dm_verity_make_ext4fs_mt6757.py
endif
ifeq ($(TARGET_SOC),exynos5433)
...
ifeq ($(TARGET_SOC),exynos8895)
LOCAL_SRC_FILES := dm_verity_make_ext4fs_8895.py
endif
ifeq ($(TARGET_SOC),exynos7420)
...
ifeq ($(TARGET_SOC),exynos7880)
LOCAL_SRC_FILES := dm_verity_make_ext4fs_7880.py
endif
ifeq ($(TARGET_PROJECT), TRE)
...
ifeq ($(TARGET_SOC),exynos7570)
LOCAL_SRC_FILES := dm_verity_make_ext4fs_7570.py
endif
ifeq ($(TARGET_SOC),exynos3475)
